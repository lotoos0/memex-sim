...
export const TRADE_SIZE_BUCKETS_SOL = [0.03, 0.05, 0.1, 0.25, 0.5, 1.0, 1.5, 2.5] as const;
...
const TRADE_SIZE_WEIGHTS_BY_REGIME: Record<TokenMarketRegime, readonly number[]> = {
  LAUNCH_CHAOS: [0.02, 0.1, 0.18, 0.25, 0.22, 0.15, 0.06, 0.02],
  FIRST_PUMP: [0.015, 0.08, 0.16, 0.25, 0.24, 0.17, 0.075, 0.02],
  CHOP: [0.05, 0.15, 0.23, 0.24, 0.19, 0.1, 0.03, 0.01],
  GRIND_UP: [0.03, 0.1, 0.18, 0.25, 0.22, 0.14, 0.06, 0.02],
  BLEED_OUT: [0.08, 0.18, 0.24, 0.23, 0.17, 0.075, 0.02, 0.005],
  DEAD_BOUNCE: [0.14, 0.24, 0.25, 0.19, 0.11, 0.05, 0.02, 0],
  MIGRATION_SHOCK: [0.015, 0.06, 0.14, 0.23, 0.25, 0.18, 0.09, 0.035],
  POST_MIGRATION_DISCOVERY: [0.02, 0.08, 0.16, 0.24, 0.23, 0.16, 0.08, 0.03],
};
  ...
  switch (regime) {
    case 'LAUNCH_CHAOS':
      return {
        ...
        cadenceBurstChance: 0.28,
        cadenceBurstDurationMinSec: 2,
        cadenceBurstDurationMaxSec: 4.5,
        cadenceBurstIntensity: 0.9,
    ...
    case 'CHOP':
      return {
        ...
        postMigrationMeanReversionChance: 0,
        postMigrationOverextensionPenalty: 0,
        cadenceBurstChance: 0.17,
        cadenceBurstDurationMinSec: 2,
        cadenceBurstDurationMaxSec: 4.5,
        cadenceBurstIntensity: 0.6,
        postMigrationBleedRetestChance: 0,
        postMigrationBleedBounceChance: 0,
        postMigrationBleedRejectionChance: 0,
        postMigrationBleedNoise: 0,
    ...
    case 'BLEED_OUT':
      return {
        ...
        postMigrationBleedRetestChance: 0.31,
    ...
    case 'POST_MIGRATION_DISCOVERY':
      return {
        ...
        postMigrationMeanReversionChance: POST_MIGRATION_MEAN_REVERSION_CHANCE,
        postMigrationOverextensionPenalty: POST_MIGRATION_OVEREXTENSION_PENALTY,
        cadenceBurstChance: 0.19,
        cadenceBurstDurationMinSec: 2,
        cadenceBurstDurationMaxSec: 4.5,
        cadenceBurstIntensity: 0.66,
        postMigrationBleedRetestChance: 0.2,
